export const calculate = (queue:string) => {
    console.log('0',queue)
    let result = ''
...
const commasToDots = (queue:string) => {
...
const calculatePercents = (queue:string) => {
...
const calculateRoots = (queue:string) => {

    let subArr1,subStr,go1:boolean,rootRes, result = queue
...
const calculateMultDevide = (queue:string) => {
...
const calculatePlusMinus = (queue:string) => {
...
export const round = (queue:string) => {
...
///////////////////
const replaceSubStr = (result:string,index:number, mode = 2) => {
    let subArr1,subArr2,go1:boolean,go2:boolean,subStr
...
function findNumber (index:number,num:string,arr:Array<string>):any {
